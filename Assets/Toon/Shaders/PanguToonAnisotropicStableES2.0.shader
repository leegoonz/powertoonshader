...
////// Emissive:
                ...
                float3 node_9147 = (AmbientColorTex*AmbientLight*_ColorShadeScale);
                ...
                half node_6746 = (1.0-AmbientDetailTex);
                float node_5083 = (node_4569-(node_6746*node_4569));
                float3 node_6630 = AmbientColorTex;
                half3 BlendAmbientDetailTex = (node_5083+node_6630);
                float3 node_315 = BlendAmbientDetailTex;
                half3 ToonBase = (_ToonRamp_var.rgb*node_315); // Toon Base
                half3 AmbientShading = lerp(node_9147,(MainColor*DiffuseIBL),ToonBase); // Ambient Shading
                half4 _DiffuseTextue_var = tex2D(_DiffuseTextue,TRANSFORM_TEX(i.uv0, _DiffuseTextue));
                half3 MainTex = _DiffuseTextue_var.rgb;
                ...
                float3 node_2034 = (AmbientShading+((Diffuse+Specular)*LightColor*LightAtten)+FresnelMatcap);
                half3 LightModel = node_2034; // Lighting Model Base
